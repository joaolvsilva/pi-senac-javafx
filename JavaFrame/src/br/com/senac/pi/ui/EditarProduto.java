...
public class EditarProduto extends javax.swing.JFrame {
    ...
    //Construtor passando parametro para a pagina de editar produtos
    public EditarProduto(String c, String n,double p) {
        initComponents();
        txtCodigo.setText(c);
        txtNome.setText(n);
        txtPreco.setText(Double.toString(p));
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        Produtos attProduto = new Produtos();
        ProdutoRepositorio att = new  ProdutoRepositorio();
        
        attProduto.setCodigo(txtCodigo.getText());
        attProduto.setNome(txtNome.getText());
        attProduto.setPreco(0);
